        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your packange has been shipped. Delivery usually takes 2-3 working
              days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any query, Please feel free to contact us with your
              order number.
            </Text>
          </Section>
          <Hr style={global.hr} />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any query (If you reply to this
