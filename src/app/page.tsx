...
import { Phone, MaxWidthWrapper, Icons, Reviews } from "@/components/index";
...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-20 xl:pt-20 lg:pb-52">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-12 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone className="w-64" imgSrc="/testimonials/1.1.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
